...
\item A plant-inventory audit now distinguishes the full eGRID2023 attributional inventory---8,802 positive-generation plant records across the 23 balancing authorities represented by the HDC sample---from the separate 3,318-row cartographic source used for figure preparation.
\end{itemize}
